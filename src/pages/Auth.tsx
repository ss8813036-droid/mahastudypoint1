...
export default function Auth() {
  ...
  const googleEnabled = isEnabled("google_signin_enabled");
  const forgotEnabled = isEnabled("forgot_password_enabled");
  const signupAllowed = isEnabled("signup_enabled");
